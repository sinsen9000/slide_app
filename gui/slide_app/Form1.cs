...
namespace slide_app
{
    public partial class Form1 : Form
    {
        ...
        private void GenerateButton_Click(object sender, EventArgs e)
        {
            ...
            Cue_card m_last_1 = new Cue_card { No = notes[notes.Count - 1].No + 1, Num = notes[notes.Count - 1].Num, Id = 21, Pnt = "。", Sentence = String.Format("この動画は、voicevox{0}の音声でお送り致しました。", VoiceNameCombo.Text), Bracket = String.Format("VOICEVOX: {0}", VoiceNameCombo.Text), Size = 10 };
